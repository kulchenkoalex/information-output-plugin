...
+define("INFORMATIONOUTPUT_PlUGIN_DIR", plugin_dir_path(__FILE__));
 ...
 +define("INFORMATIONOUTPUT_PlUGIN_SLUG", preg_replace( '/[^\da-zA-Z]/i', '_',  basename(STEPBYSTEP_PlUGIN_DIR)));
 +define("INFORMATIONOUTPUT_PlUGIN_TEXTDOMAIN", str_replace( '_', '-', STEPBYSTEP_PlUGIN_SLUG ));
 +define("INFORMATIONOUTPUT_PlUGIN_OPTION_VERSION", STEPBYSTEP_PlUGIN_SLUG.'_version');
 +define("INFORMATIONOUTPUT_PlUGIN_OPTION_NAME", STEPBYSTEP_PlUGIN_SLUG.'_options');
